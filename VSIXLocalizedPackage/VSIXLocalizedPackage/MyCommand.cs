...
namespace VSIXLocalizedPackage
{
   ...
   internal sealed class MyCommand
   {
      ...
      /// </summary>
      public static readonly Guid CommandSet = new Guid("edc10475-baa3-4e7b-8145-7ae9d49c303d");
      ...
      {
         string message = string.Format(CultureInfo.CurrentCulture, "{0}.MenuItemCallback()", this.GetType().FullName);
